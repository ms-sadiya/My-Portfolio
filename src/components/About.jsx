...
const About = () => (
  <section id="about" className="py-32 px-4 relative">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <motion.div {...fadeInUp} className="p-10 md:p-16 rounded-[3rem] border backdrop-blur-xl bg-white/50 border-slate-200 shadow-2xl text-left">
        ...
        <div className="grid md:grid-cols-2 gap-8 text-lg text-slate-500 leading-relaxed">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-16">
          {[{ label: 'Problem Solver', emoji: '🧩' }, { label: 'Team Player', emoji: '🤝' }, { label: 'Fast Learner', emoji: '📚' }, { label: 'UI Obsessed', emoji: '✨' }].map((item, i) => (
            <div key={i} className="p-4 rounded-2xl text-center border font-bold bg-slate-100 border-slate-200">
